...
public class Array_sd {
	...
	@Given("The user is in the Array page after logging in")
	public void the_user_is_in_the_array_page_after_logging_in() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void user_clicks_run_button_after_writing_valid_code_in_editor() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void user_clicks_applications_of_array() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@Then("The user should be navigated to Applications of Array page")
	public void user_should_be_navigated_to_applications_of_array_page() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void the_user_should_be_redirected_to_question_page_contains_a_question_try_editor_with_run_and_submit_buttons() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void the_user_clicks_submit_button_after_writing_valid_code_in_editor() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	@When("The user clicks Arrays Using List page")
	public void the_user_clicks_arrays_using_list_page() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@Then("The user should be navigated to Arrays Using List page")
	public void the_user_should_be_navigated_to_arrays_using_list_page() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
